...
| ![PIR Movement sensor board qwiic Image](https://solde.red/333179/image) |
| :----------------------------------------------------------: |
| [Buy PIR Movement sensor board qwiic](https://www.solde.red/333179) |
...
Our breakout board simplifies the use of the PIR sensor by using qwiic technology, making it easily connectable with microcontrollers or other circuits. It accepts input from the PIR sensor and translates it into signals that your microcontroller can interpret. In addition to the aforementioned PIR sensor, the board also contains a small ATTiny404 microcontroller, as well as a switch for selecting the I2C address. This breakout board comes with 2 qwiic connectors for easy integration into the qwiic system. If you do not wish to use qwiic, the module can also be used via standard headers.
...
This repository contains all design files for PIR Movement sensor board qwiic, organized as follows:
